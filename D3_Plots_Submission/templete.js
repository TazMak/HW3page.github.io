...
socialMedia.then(function(data) {
    ...
    // Groups the data by AgeGroup and applies rollupFunction to calculate summary statistics (min, q1, median, q3, max) for each group
    const quantilesByGroups = d3.rollup(data, rollupFunction, d => d.AgeGroup);

    // Iterates through each age group and its calculated quantiles to position and draw the boxplot elements
